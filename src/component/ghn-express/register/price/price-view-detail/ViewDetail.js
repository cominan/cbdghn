    ...
    return (
        <div className='mt-32 mobile:mt-56'>
            <div className='bg-[#fafafa] h-20 tablet:-mx-20 flex items-center text-[15px]'>
                ...
                <p className='ml-6 text-[#777b83]'>Bảng giá mới siêu tiết kiệm - Giá chỉ từ 15,5k/đơn</p>
            </div>
            <div  className='container'>
                <div className='text-center mt-14'>
                    <h3 className='text-5xl text-[#00467f] font-bold'>BẢNG GIÁ MỚI SIÊU TIẾT KIỆM - GIÁ CHỈ TỪ 15,5K/ĐƠN</h3>
                    <div className='border-b-[2.5px] mt-6 border-[#00467f] m-auto w-[52%] mb-24'></div>
                </div>
                <div>
                    <div className='laptop:-mx-32'>
                        <img alt='Lời ngỏ cám ơn' src='//file.hstatic.net/200000472237/file/web_c2796443da6142aba36333655e77da0c_master.jpg'></img>
                    </div>
