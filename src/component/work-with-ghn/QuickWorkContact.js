        ...
        <div className='laptop:w-[30%] pr-6 items-start'>
            <div className='sticky top-[90px]'>
                <ul className='mb-20'>
                    ...
                    <ul className='ml-4'>
                        <Link className='hover:no-underline hover:cursor-pointer h-full w-full modalKvp'
                            to='/pages/block/office'>
                            <li className='list-disc list-inside text-[#00476f] text-2xl py-4 border-b-2'>Khối văn phòng</li>
                        </Link>
                        <ModalKvp />
                        <Link className='hover:no-underline hover:cursor-pointer h-full w-full'
                            to='/pages/notification'>
                            <li className='list-disc list-inside text-[#00476f] text-2xl py-4 border-b-2'>Khối công nghệ</li>
                        </Link>
                        <Link className='hover:no-underline hover:cursor-pointer h-full w-full'
                            to='/pages/notification'>
                            <li className='list-disc list-inside text-[#00476f] text-2xl py-4 border-b-2'>Khối vận hành</li>
                        </Link>
                        <Link className='hover:no-underline hover:cursor-pointer h-full w-full'
                            to='/pages/notification'>
                            <li className='list-disc list-inside text-[#00476f] text-2xl py-4 border-b-2'>Khối kinh doanh</li>
                        </Link>
                        <Link className='hover:no-underline hover:cursor-pointer h-full w-full'
                            to='/pages/notification'>
                            <li className='list-disc list-inside text-[#00476f] text-2xl py-4 border-b-2'>Làm việc bán thời gian</li>
                        </Link>
                    </ul>
                </ul>
                <div className='relative -mx-4 bg-[#ffffff] dark:!bg-dark dark:text-white'>
                    ...
                    <ul className='flex flex-wrap mt-6'>
                        <li className='bg-[#f9f9fb] w-[30%] dark:!bg-dark dark:text-white text-center py-[12px] m-[2px]'>
