  ...
  return (
    <div className='grid grid-cols-10 mt-20 items-start '>
      <div className='col-span-3'>
        <div className='grid grid-rows-2'>
          <div className='flex items-center'>
            <img className='w-[60px] border-2 shadow-xl mr-6' src='https://theme.hstatic.net/200000472237/1000829412/14/logo-footer.png?v=491' alt='GHN'></img>
            <h4 className='font-bold text-2xl leading-9'>TRẢI NGHIỆM TỐT HƠN VỚI<br></br>
              APP GHN EXPRESS</h4>
          </div>
      ...
      <div className='col-span-2'>
        ...
        <button className='border-[1px] hover:border-[1px] hover:border-primary border-primary mt-4 p-3 z-[1] rounded-xl location'><a className='hover:no-underline' href="http://ghn-express.myharavan.com/blogs/he-thong-buu-cuc">TÌM ĐỊA CHỈ GẦN BẠN</a></button>
      </div>
      <div className='col-span-2'>
